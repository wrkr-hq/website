...
const OnboardingSection = () => {
  return (
    <div>
        <main className='max-w-[1440px] flex-wrap mx-auto bg-[url("../public/vector2.png")] bg-no-repeat bg-right bg-half max-h-[800px] pb-[3.75rem]'>
            ...
            <div className='flex flex-col'>
              ...
              <div className='flex  items-center pl-[160px]'>
                <div className='w-[498px] mr-[100px]'>
                  <div className='text-3xl font-semibold pb-8'>End-to-End identity verification for onboarding in 10 seconds</div>
                  <div>
